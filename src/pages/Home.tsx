...
import CoinAnimation from "../components/animationLottie/CoinAnimation";
...
function Home() {
    ...
    return (
        <div className="flex flex-col justify-center items-center gap-4">
            ...
            <small className="mx-3 text-center">{!profile ? '(Ceci est en mode démo, les modifications que vous effectuez ne seront pas sauvegardées.)' : ''}</small>
            <CoinAnimation />
