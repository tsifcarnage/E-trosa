        ...
        <nav className="flex justify-between p-4 sticky top-0 z-1 bg-base-100">
            ...
            <section className="ml-auto flex gap-2">
                ...
                <div className="relative">
                    ...
                    {isSummaryOpen && (
                        <ul className="  dropdown-content btn-neutral box-shad-user w-full rounded-b-2xl text-center p-2 absolute -z-1 top-10 left-0">
                            <li className=" pt-4 hover:text-[#8a38f5c8] border-b border-b-[#8a38f5c8] py-2 cursor-pointer">
